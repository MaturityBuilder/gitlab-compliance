...
@click.option(
    ...
    "attributes",
    required=False,
    help="Comma-separated list of GitLab CI YAML attributes to export.",
    default="README.md",
)
@click.option(
    "--output-file",
...
@click.option(
    ...
    "GLDOCS_CONFIG_FILE",
    required=False,
    help="GitLab CI input configuration file to read.",
...
@click.option(
    ...
    "GLDOCS_CONFIG_FILE",
    required=False,
    help="GitLab CI input configuration file to document.",
    default=".gitlab-ci.yml",
)
@click.option(
    "--exclude",
