...
Branch names, commit messages, and PR titles follow [Conventional Commits](https://www.conventionalcommits.org/). Every pull request should link a **user story** GitHub issue (`Closes #123`). See [CONTRIBUTING.md](CONTRIBUTING.md), [AGENTS.md](AGENTS.md), and the [user story issue template](.github/ISSUE_TEMPLATE/user_story.yml).
...
- [GitHub Actions workflows](.github/workflows/README.md) — CI, PR policy, PyPI, and container builds
