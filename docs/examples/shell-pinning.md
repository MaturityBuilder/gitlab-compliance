...
with IDs `GLCI-BUILTIN-SHELL-PIN-001` … `GLCI-BUILTIN-SHELL-PIN-010`.
...
### apk (`GLCI-BUILTIN-SHELL-PIN-004`)
...
### apt / apt-get (`GLCI-BUILTIN-SHELL-PIN-005`)
...
### yum / dnf / microdnf (`GLCI-BUILTIN-SHELL-PIN-010`)
...
### pip / pip3 (`GLCI-BUILTIN-SHELL-PIN-003`)
...
### npm / yarn (`GLCI-BUILTIN-SHELL-PIN-006`)
...
### git clone (`GLCI-BUILTIN-SHELL-PIN-008`)
...
### docker run / pull / create (`GLCI-BUILTIN-SHELL-PIN-009`)
