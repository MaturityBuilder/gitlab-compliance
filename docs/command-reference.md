...
```
Usage: gitlab-docs generate-html [OPTIONS]
```
...
```
Usage: gitlab-docs compliance [OPTIONS]
```
...
* `output_format`: 
  * Type: Choice(['console', 'markdown', 'html', 'mr-comment']) 
  * Default: `console`
  * Usage: `--format`
...
Options:
  ...
  --format [console|markdown|html|mr-comment]
                                  Output format for the compliance report.
...
```
Usage: gitlab-docs compliance-doc [OPTIONS]
```
...
```
Usage: gitlab-docs compliance-push [OPTIONS] TARGET
```
...
```
Usage: gitlab-docs compliance-pull [OPTIONS] TARGET
```
...
```
Usage: gitlab-docs release-notes [OPTIONS]
```
...
* `markdown_dir`: 
  * Type: <click.types.Path object at 0x70a16441ab10> 
  * Default: `.`
  * Usage: `--markdown`
